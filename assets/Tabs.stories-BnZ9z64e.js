import{a as b}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{T as t,a as i,b as s,S as g}from"./Tabs-DAAvhP7J.js";import{a}from"./Shadow-ELLRTBGu.js";import"./v4-CQkTLCs1.js";import"./vue.esm-bundler-BHwbD8xO.js";import"./Icon-LmhyBlqB.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Button-Cqby2nDZ.js";import"./Loader-DVyLjiyj.js";const o=Object.values(t),n=Object.values(i),r=Object.values(s),u=Object.values(a),h=[{icon:"action-messenger",id:"item_1",title:"Lorem Ipsum - Tab 1"},{icon:"action-messenger",id:"item_1B",title:"Lorem Ipsum - Tab 1B",disabled:!0},{icon:"arrow-large-up-right",id:"item_2",title:"Lorem Ipsum - Tab 2"},{icon:"package-express-stamp",id:"item_3",title:"Lorem Ipsum - Tab 3"}],_={title:"Molecules/Tabs",argTypes:{defaultSelection:{description:"Which tab is selected onload",table:{type:{summary:"string"}}},fullContainer:{description:"Make tabs occupy the entire width of the component.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},overflowScroll:{description:"Use the width of the component (true) or activate the scroll (false)",table:{type:{summary:"boolean"},defaultValue:{summary:"true"}}},iconPosition:{description:"Position of the tab icon",table:{type:{summary:n.join(" | ")},defaultValue:{summary:i.left}},control:{type:"select"},options:n},id:{description:"To identify the Tabs component in the page",table:{type:{summary:"string"}}},items:{description:"List of buttons to control the panels",table:{type:{summary:"Array<TabItems>",detail:`[{
            id: string
            disabled?: boolean
            iconName?: string
            label: string
