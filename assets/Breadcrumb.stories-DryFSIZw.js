import{S as s}from"./Breadcrumb-gcmQARrc.js";import"./vue.esm-bundler-BV06ZB-3.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const o=`[
  {
    label: string,
    url: string
  }
]`,i=[{label:"item1",url:"item1"},{label:"item2",url:"item2"},{label:"item3",url:"item3"}],c={title:"Atoms/Breadcrumb",component:s,argTypes:{ariaLabel:{description:`Accessible label for the breadcrumb navigation. If empty, default is "Fil d'ariane"`,control:"text",table:{type:{summary:"string"}},defaultValue:{summary:"Fil d'ariane"}},items:{description:"List of elements of the breadcrumb in the downward direction.",table:{type:{summary:"array",detail:o}},type:{required:!0}}},args:{items:i,ariaLabel:""}},e={render:m=>({components:{SolarisBreadcrumb:s},setup(){return{args:m}},template:'<SolarisBreadcrumb v-bind="args" />'}),args:{items:i}};var r,a,t;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: (args: any) => ({
    components: {
      SolarisBreadcrumb
    },
