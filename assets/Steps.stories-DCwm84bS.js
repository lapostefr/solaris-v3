import{a as o}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{S as f}from"./Steps-BHRSiauC.js";import{r,w as d}from"./vue.esm-bundler-DbnnIJWB.js";import"./v4-CQkTLCs1.js";import"./Icon-BFYv-dj3.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Tooltip-CNCAgM55.js";import"./index-7Yv3mQsR.js";const O={title:"Organisms/Steps",argTypes:{color:{description:"Color of the stepper",table:{type:{summary:"string"},defaultValue:{summary:"supernova"}},control:{type:"select"},options:["supernova","colissimo"]},goToStep:{action:"goToStep"},steps:{description:"List of steps",table:{type:{summary:"array"}}},version:{description:"Responsive behavior for the Stepper",table:{type:{summary:"string"},defaultValue:{summary:"responsive"}},control:{type:"select"},options:["small","large","responsive"]}},args:{color:"colissimo",steps:[{id:"step1",label:"Label 1"},{id:"step2",label:"Label 2"},{id:"step3",label:"Label 3"},{id:"step4",label:"Label 4"}],current:2,version:"small"}},s={render:e=>({components:{SolarisSteps:f},setup(){const t=r(e.current),p=r({current:1});d(()=>e,n=>{t.value=n.current,p.value={...e},delete p.value.current},{deep:!0,immediate:!0}),d(()=>t.value,n=>{o("modelChanged")(n)});const l=o("tooltipState"),c=o("goToStep"),i=r(e.steps.length),S=r(!1),u=r(!1);return{otherProps:p,args:e,currentStep:t,maxStep:i,prevDisabled:S,nextDisabled:u,goToStep:c,tooltipState:l,nextStep:()=>{t.value++,e.current=t},prevStep:()=>{t.value--,e.current=t}}},template:`
    ...
    </div>`})},a={render:e=>({components:{SolarisSteps:f},setup(){const t=r(e.current);d(()=>e.current,n=>{t.value=n});const p=o("change"),l=o("tooltipState"),c=o("goToStep"),i=r(e.steps.length),S=r(!1),u=r(!1);return{args:e,currentStep:t,change:p,goToStep:c,tooltipState:l,maxStep:i,prevDisabled:S,nextDisabled:u,nextStep:()=>{t.value++,e.current=t},prevStep:()=>{t.value--,e.current=t}}},template:`
    <div style="padding: 30px 10px;">
...
}`,...(b=(y=a.parameters)==null?void 0:y.docs)==null?void 0:b.source}}};const j=["StepperVModel","StepperWithProps"];export{s as StepperVModel,a as StepperWithProps,j as __namedExportsOrder,O as default};
