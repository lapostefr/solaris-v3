import{d as me}from"./imageDefaultSource-CMm1GdPE.js";import{o as ue}from"./imageOtherSources-B73Rbm2K.js";const x="@/components/organisms/TileNew/mocks/colissimo.svg",r="@/components/organisms/TileNew/mocks/lettre-recommandee.svg",d="@/components/organisms/TileNew/mocks/lettre-rouge.svg",y="@/components/organisms/TileNew/mocks/demenagement-def.svg",T="@/components/organisms/TileNew/mocks/demenagement-temp.svg",w="@/components/organisms/TileNew/mocks/delivery-address.svg",e={picture:{defaultSource:me,otherSources:ue,width:80,height:80,alt:"Lorem Ipsum"},title:{content:"Tile title"}},l={bodyText:"En cas d'incident, La Poste vous indemnise 153€",title:{content:"Standard (R2)",fontSize:"16px"}},t={tileAllAvalaibleElements:{options:[{card:{...e,bodyText:'"bodyText" content',badges:[{content:"Badge",color:"info"}],expanded:!0,id:"allAvailableElements",label:"label",title:{content:"tile title",icon:"package-delivery"}},toggleText:"toggleText"}],setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-8-2 lp-col--lg-8-2",type:"Clickable"},tileClickable:{options:[{card:{...e,bodyText:'The "type" prop is "Clickable". Use "link" to add a link to the card',id:"tileClickable-1",link:"www.laposte.fr"}},{card:{...e,alignments:"center",layout:"vertical",bodyText:'Use "layout" with "vertical" value in card object in options table for vertical orientation',id:"tileClickable",link:"www.laposte.fr"}}],setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-8-2 lp-col--lg-6-3",type:"Clickable"},tileEditable:{options:[{card:{...e,bodyText:'"Editable" tiles allow the user to enter or modify information."',id:"tileEditable-1"}},{card:{...e,alignments:"center",bodyText:'"Editable" tiles allow the user to enter or modify information."',id:"tileEditable-2",layout:"vertical"}}],setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-8-2 lp-col--lg-8-2",type:"Clickable"},tileSelectableSingle:{options:[{card:{...e,bodyText:'The "type" prop is "Selectable single"',id:"tileSelectableSingle-1"},id:"radioSingle-A",name:"radioSingle",value:"radioSingle-A"},{card:{...e,bodyText:'The "type" prop is "Selectable single"',alignments:"center",id:"tileSelectableSingle-2",layout:"vertical"},id:"radioSingle-B",name:"radioSingle",value:"radioSingle-B"}],radioDefaultValue:"radioSingle-B",setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-8-2 lp-col--lg-6-3",type:"Selectable single"},tileSelectableMultiple:{options:[{card:{...e,bodyText:'The "type" prop is "Selectable multiple"',id:"tileSelectableMultiple-1"},checked:!1,id:"selectMulti-id-A",name:"selectMulti-name-A"},{card:{...e,alignments:"center",bodyText:'The "type" prop is "Selectable multiple"',id:"tileSelectableMultiple-2",layout:"vertical"},checked:!1,id:"selectMulti-id-B",name:"selectMulti-name-B"}],setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-8-2 lp-col--lg-6-3",type:"Selectable multiple"},tileExpandable:{options:[{card:{...e,bodyText:"Fill the toggleText prop to add the text 'Voir plus'",expanded:!0,id:"tileExpandable-1"},toggleText:"Voir plus"},{card:{...e,alignments:"center",bodyText:"Fill the toggleText prop to add the text 'Voir plus'",expanded:!0,id:"tileExpandable-2",layout:"vertical"},toggleText:"Voir plus"}],setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-8-2 lp-col--lg-8-2",type:"Clickable"},tileNested:{nested:!0,options:[{card:{...e,bodyText:"The Nested tile is used when it is nested within another tile",id:"tileNested-1"},id:"radioNested-A",name:"radioNested",value:"radioNested-A"},{card:{...e,alignments:"center",bodyText:'The Nested tile is used when it is nested within another tile. Set "nested" prop to true',id:"tileNested-2",layout:"vertical"},id:"radioNested-B",name:"radioNested",value:"radioNested-B"}],radioDefaultValue:"radioNested-A",setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-8-2 lp-col--lg-8-2",type:"Selectable single"},tileNestedComponentSingle:{options:[{card:{id:"nested-component-single-1",picture:{...e.picture},title:{content:"Lettre recommandée",fontSize:"18px"}},id:"radio-nested-component-single-1",name:"nested-component-single",value:"radio-nested-component-single-1"},{card:{id:"nested-component-single-2",picture:{...e.picture},title:{content:"Lettre verte",fontSize:"18px"}},id:"radio-nested-component-single-2",name:"nested-component-single",value:"radio-nested-component-single-2"}],setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-10-1 lp-col--lg-10-1",showMoreWhenSelected:!0,type:"Selectable single"},tileNestedComponentSingleChildrenA:{nested:!0,options:[{card:{...l,id:"nested-component-single-child-1"},id:"radio-nested-component-single-child-1",name:"nested-component-single-child-A",value:"radio-nested-component-single-child-1"},{card:{...l,id:"nested-component-single-child-2"},id:"radio-nested-component-single-child-2",name:"nested-component-single-child-A",value:"radio-nested-component-single-child-2"}],setItemClass:"lp-col--4 lp-col--sm-5 lp-col--md-10 lp-col--lg-10",type:"Selectable single"},tileNestedComponentSingleChildrenB:{nested:!0,options:[{card:{...l,id:"nested-component-single-child-3"},id:"radio-nested-component-single-child-3",name:"nested-component-single-child-B",value:"radio-nested-component-single-child-3"},{card:{...l,id:"nested-component-single-child-4"},id:"radio-nested-component-single-child-4",name:"nested-component-single-child-B",value:"radio-nested-component-single-child-4"}],setItemClass:"lp-col--4 lp-col--sm-5 lp-col--md-10 lp-col--lg-10",type:"Selectable single"},tileNestedComponentMultiple:{options:[{card:{id:"nested-component-multiple-1",picture:{...e.picture},title:{content:"Lettre recommandée",fontSize:"18px"}},checked:!1,disabled:!1,id:"checkbox-nested-component-multiple-1",name:"nested-component-multiple-A",value:"checkbox-nested-component-multiple-1"},{card:{id:"nested-component-multiple-2",picture:{...e.picture},title:{content:"Lettre verte",fontSize:"18px"}},checked:!1,disabled:!1,id:"checkbox-nested-component-multiple-2",name:"nested-component-multiple-B",value:"checkbox-nested-component-multiple-2"}],setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-10-1 lp-col--lg-10-1",type:"Selectable multiple",showMoreWhenSelected:!0},tileNestedComponentMultipleChildrenA:{nested:!0,options:[{card:{...l,id:"nested-component-multiple-child-1"},id:"radio-nested-component-multiple-child-1",name:"nested-component-multiple-child-A",value:"radio-nested-component-multiple-child-1"},{card:{...l,id:"nested-component-multiple-child-2"},id:"radio-nested-component-multiple-child-2",name:"nested-component-multiple-child-A",value:"radio-nested-component-multiple-child-2"}],setItemClass:"lp-col--4 lp-col--sm-5 lp-col--md-10 lp-col--lg-10",type:"Selectable single"},tileNestedComponentMultipleChildrenB:{nested:!0,options:[{card:{...l,id:"nested-component-multiple-child-3"},id:"radio-nested-component-multiple-child-3",name:"nested-component-multiple-child-B",value:"radio-nested-component-multiple-child-3"},{card:{...l,id:"nested-component-multiple-child-4"},id:"radio-nested-component-multiple-child-4",name:"nested-component-multiple-child-B",value:"radio-nested-component-multiple-child-4"}],setItemClass:"lp-col--4 lp-col--sm-5 lp-col--md-10 lp-col--lg-10",type:"Selectable single"},tileExpandableWithMoreInfo:{options:[{card:{expanded:!0,id:"tile-colissimo",picture:{defaultSource:{alt:"Mon image",mimeType:"image/jpg",url:x},otherSources:{alt:"Mon image",mimeType:"image/jpg",url:x},width:20,height:20,alt:"Lorem Ipsum"}},toggleText:"Exp"}]},tileSelectableSingleWithMoreInfo:{options:[{card:{id:"registeredLetter-1",picture:{defaultSource:{alt:"Mon image",mimeType:"image/jpg",url:r},otherSources:{alt:"Mon image",mimeType:"image/jpg",url:r},width:20,height:20,alt:"Lorem Ipsum"},link:"www.laposte.fr",title:{content:"Lettre recommandée",fontSize:"18px",lineHeight:"var(--size-24)",titleLevel:"h1",weight:"700"}},checked:!1,disabled:!1,id:"registeredLetter-1",name:"letters-1",value:"registeredLetter-1"},{card:{id:"redLetter",picture:{defaultSource:{alt:"Mon image",mimeType:"image/jpg",url:d},otherSources:{alt:"Mon image",mimeType:"image/jpg",url:d},width:20,height:20,alt:"Lorem Ipsum"},title:{content:"e-lettre rouge",fontSize:"18px",lineHeight:"var(--size-24)",titleLevel:"h1",weight:"700"}},checked:!1,disabled:!1,id:"redLetter-1",name:"letters-1",value:"redLetter-1"}],setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-10-1 lp-col--lg-10-1",type:"Selectable single",showMoreWhenSelected:!0},tileSelectableSingleWithMoreInfoOpen:{options:[{card:{expanded:!0,id:"registeredLetter-2",picture:{defaultSource:{alt:"Mon image",mimeType:"image/jpg",url:r},otherSources:{alt:"Mon image",mimeType:"image/jpg",url:r},width:20,height:20,alt:"Lorem Ipsum"},link:"www.laposte.fr",title:{content:"Lettre recommandée",fontSize:"18px",lineHeight:"var(--size-24)",titleLevel:"h1",weight:"700"}},checked:!1,disabled:!1,id:"registeredLetter-2",name:"letters-2",value:"registeredLetter-2"},{card:{expanded:!0,id:"redLetter-2",picture:{defaultSource:{alt:"Mon image",mimeType:"image/jpg",url:d},otherSources:{alt:"Mon image",mimeType:"image/jpg",url:d},width:20,height:20,alt:"Lorem Ipsum"},title:{content:"e-lettre rouge",fontSize:"18px",lineHeight:"var(--size-24)",titleLevel:"h1",weight:"700"}},checked:!1,disabled:!1,id:"redLetter-2",name:"letters-2",value:"redLetter-2"}],setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-10-1 lp-col--lg-10-1",type:"Selectable single",showMoreWhenSelected:!0},tileSelectableMultipleWithMoreInfo:{options:[{card:{bodyText:"Vous quittez définitivement votre adresse actuelle.",id:"moving-def",picture:{defaultSource:{alt:"Mon image",mimeType:"image/jpg",url:y},otherSources:{alt:"Mon image",mimeType:"image/jpg",url:y},width:20,height:20,alt:"Lorem Ipsum"},link:"www.laposte.fr",title:{content:"Je déménage",fontSize:"18px",lineHeight:"var(--size-24)",titleLevel:"h1",weight:"700"}},checked:!1,disabled:!1,id:"moving-def",name:"moving-final",value:"moving-def"},{card:{bodyText:"Vous quittez temporairement votre adresse actuelle.",id:"moving-temp",picture:{defaultSource:{alt:"Mon image",mimeType:"image/jpg",url:T},otherSources:{alt:"Mon image",mimeType:"image/jpg",url:T},width:20,height:20,alt:"Lorem Ipsum"},title:{content:"Je m'absente",fontSize:"18px",lineHeight:"var(--size-24)",titleLevel:"h1",weight:"700"}},checked:!1,disabled:!1,id:"moving-temp",name:"moving-temporary",value:"moving-temp"},{card:{bodyText:"Je m'absente régulièrement pour des période de courte durée.",id:"mobility-subscription",picture:{defaultSource:{alt:"Mon image",mimeType:"image/jpg",url:w},otherSources:{alt:"Mon image",mimeType:"image/jpg",url:w},width:20,height:20,alt:"Lorem Ipsum"},title:{content:"Abonnement Mobilité",fontSize:"18px",lineHeight:"var(--size-24)",titleLevel:"h1",weight:"700"}},checked:!1,disabled:!1,id:"mobility-subscription",name:"moving-subscription",value:"mobility-subscription"}],setItemClass:"lp-col--4 lp-col--sm-4-1 lp-col--md-10-1 lp-col--lg-10-1",type:"Selectable multiple",showMoreWhenSelected:!0}},ge={title:"Organisms/Tile (New)/Examples",parameters:{previewTabs:{canvas:{hidden:!0}},viewMode:"docs",docs:{description:{component:"The **Tile component** allows you to detail and highlight single or multiple choices from a list. **The tile uses the SolarisCard component**, allowing you to use all its props according to your needs."}}}},o=(s,i,ce="lp-grid")=>pe=>({props:Object.keys(pe),data:()=>({data:s}),template:`
  ...
  `),p=o(t.tileClickable,`<template #tileFooter>
    <div class="tile-clickable__icon">
      <SolarisIcon name="arrow-right" />
    </div>
   </template>`),m=o(t.tileEditable,`<template #tileFooter>
  ...
  </template>`),u=o(t.tileSelectableSingle,`<template #tileFooter>
      <div class="tile__price">Price</div>
   </template>`),v=o(t.tileSelectableMultiple,`<template #tileFooter>
      <div class="tile__price">Price</div>
   </template>`),h=o(t.tileExpandable,`<template #tileExtra>
      <div class="slot">
        <h3>Slot - tileExtra</h3>
        <p>To make the tile expandable, fill in the tileExtra slot and set the toggleText prop.</p>
      </div>
  </template>`),g=o(t.tileNested,`<template #tileFooter>
      <div class="tile__price">Price</div>
   </template>`),_=(s,{argTypes:i})=>({props:Object.keys(i),data:()=>({data1:t.tileNestedComponentSingle,data2:t.tileNestedComponentSingleChildrenA,data3:t.tileNestedComponentSingleChildrenB}),template:`<SolarisTileNew v-bind="data1" class="lp-grid">
  <template #tileBody>
...
</SolarisTileNew>`}),S=(s,{argTypes:i})=>({props:Object.keys(i),data:()=>({data1:t.tileNestedComponentMultiple,data2:t.tileNestedComponentMultipleChildrenA,data3:t.tileNestedComponentMultipleChildrenB}),template:`<SolarisTileNew v-bind="data1" class="lp-grid">
  <template #tileBody>
     <ul class="tile__description-list">
       <li>Distribution en 3 jours (délai indicatif) *</li>
       <li>Suivi inclus</li>
...
</SolarisTileNew>`}),b=o(t.tileExpandableWithMoreInfo,`<template #tileBody>
  ...
  </template>`,""),a=(s,{argTypes:i})=>({props:Object.keys(i),data:()=>({data:t.tileSelectableSingleWithMoreInfo}),template:`<SolarisTileNew v-bind="data" class="lp-grid">
...
</SolarisTileNew>`}),f=(s,{argTypes:i})=>({props:Object.keys(i),data:()=>({data:t.tileSelectableSingleWithMoreInfoOpen}),template:`<SolarisTileNew v-bind="data" class="lp-grid">
  <template #tileBody="{ index }">
...
</SolarisTileNew>`}),n=(s,{argTypes:i})=>({props:Object.keys(i),data:()=>({data:t.tileSelectableMultipleWithMoreInfo}),template:`<SolarisTileNew v-bind="data" class="lp-grid">
  <template v-slot:tileExtra="{ index }">
...
</SolarisTileNew>`});a.parameters={docs:{description:{story:"Cards datas are inserted via the prop <em>options</em> (title, picture and radio infos).<br />Use the prop <em>showMoreWhenSelected </em>to display the content of the Tile when selected, and the <em>type</em> prop with <em>Selectable single</em> for the selection mode.<br />Each slot (tileBody for the list below the title; tileFooter for price; tileExtra for tile contents), receives the index as a prop, and is used to access information specific to the current option. Depending on the ID of the current option, the rendered content can be adapted to display different contents."}}};n.parameters={docs:{description:{story:"Cards datas are inserted via the prop <em>options</em> (title, picture, bodyText and checkbox infos).<br />Use the prop <em>showMoreWhenSelected </em>to display the content of the Tile when selected, and the <em>type</em> prop with <em>Selectable multiple</em> for the selection mode.<br />TileExtra slot for tile contents, receives the index as a prop, and is used to access information specific to the current option. Depending on the ID of the current option, the rendered content can be adapted to display different contents."}}};var k,E,I;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`generateTile(data.tileAllAvalaibleElements, \`<template #tileBody>
    <div class="slot">Slot - tileBody</div>
   </template>
   <template #tileFooter>
    <div class="slot">Slot - tileFooter</div>
  ...
  \`)`,...(I=(E=c.parameters)==null?void 0:E.docs)==null?void 0:I.source}}};var C,N,M;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`generateTile(data.tileClickable, \`<template #tileFooter>
    <div class="tile-clickable__icon">
      <SolarisIcon name="arrow-right" />
    </div>
   </template>\`)`,...(M=(N=p.parameters)==null?void 0:N.docs)==null?void 0:M.source}}};var L,D,B;m.parameters={...m.parameters,docs:{...(L=m.parameters)==null?void 0:L.docs,source:{originalSource:`generateTile(data.tileEditable, \`<template #tileFooter>
      <div class="tile-editable__actions">
        <SolarisButton
          class="tile-editable__action"
          icon="action-pen"
  ...
  </template>\`)`,...(B=(D=m.parameters)==null?void 0:D.docs)==null?void 0:B.source}}};var z,j,O;u.parameters={...u.parameters,docs:{...(z=u.parameters)==null?void 0:z.docs,source:{originalSource:'generateTile(data.tileSelectableSingle, `<template #tileFooter>\n      <div class="tile__price">Price</div>\n   </template>`)',...(O=(j=u.parameters)==null?void 0:j.docs)==null?void 0:O.source}}};var A,F,R;v.parameters={...v.parameters,docs:{...(A=v.parameters)==null?void 0:A.docs,source:{originalSource:'generateTile(data.tileSelectableMultiple, `<template #tileFooter>\n      <div class="tile__price">Price</div>\n   </template>`)',...(R=(F=v.parameters)==null?void 0:F.docs)==null?void 0:R.source}}};var W,P,V;h.parameters={...h.parameters,docs:{...(W=h.parameters)==null?void 0:W.docs,source:{originalSource:`generateTile(data.tileExpandable, \`<template #tileExtra>
      <div class="slot">
        <h3>Slot - tileExtra</h3>
        <p>To make the tile expandable, fill in the tileExtra slot and set the toggleText prop.</p>
      </div>
  </template>\`)`,...(V=(P=h.parameters)==null?void 0:P.docs)==null?void 0:V.source}}};var q,H,G;g.parameters={...g.parameters,docs:{...(q=g.parameters)==null?void 0:q.docs,source:{originalSource:'generateTile(data.tileNested, `<template #tileFooter>\n      <div class="tile__price">Price</div>\n   </template>`)',...(G=(H=g.parameters)==null?void 0:H.docs)==null?void 0:G.source}}};var U,J,$;_.parameters={..._.parameters,docs:{...(U=_.parameters)==null?void 0:U.docs,source:{originalSource:`(args: any, {
  argTypes
}: {
  argTypes: any;
}) => ({
...
})`,...($=(J=_.parameters)==null?void 0:J.docs)==null?void 0:$.source}}};var K,Q,X;S.parameters={...S.parameters,docs:{...(K=S.parameters)==null?void 0:K.docs,source:{originalSource:`(args: any, {
  argTypes
}: {
  argTypes: any;
}) => ({
...
})`,...(X=(Q=S.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};var Y,Z,ee;b.parameters={...b.parameters,docs:{...(Y=b.parameters)==null?void 0:Y.docs,source:{originalSource:`generateTile(data.tileExpandableWithMoreInfo, \`<template #tileBody>
    <div class="tile-colissimo__content">
      <h3 class="tile-colissimo__title">Colis</h3>
      <span class="tile-colissimo__description">Standard</span>
        <div class="tile-colissimo__infos-prices">
  ...
  </template>\`, '')`,...(ee=(Z=b.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var te,ie,le;a.parameters={...a.parameters,docs:{...(te=a.parameters)==null?void 0:te.docs,source:{originalSource:`(args: any, {
  argTypes
}: {
  argTypes: any;
}) => ({
...
})`,...(le=(ie=a.parameters)==null?void 0:ie.docs)==null?void 0:le.source}}};var oe,se,ae;f.parameters={...f.parameters,docs:{...(oe=f.parameters)==null?void 0:oe.docs,source:{originalSource:`(args: any, {
  argTypes
}: {
  argTypes: any;
}) => ({
...
})`,...(ae=(se=f.parameters)==null?void 0:se.docs)==null?void 0:ae.source}}};var ne,re,de;n.parameters={...n.parameters,docs:{...(ne=n.parameters)==null?void 0:ne.docs,source:{originalSource:`(args: any, {
  argTypes
}: {
  argTypes: any;
}) => ({
...
})`,...(de=(re=n.parameters)==null?void 0:re.docs)==null?void 0:de.source}}};const _e=["AllAvailableElements","Clickable","Editable","SelectableSingle","SelectableMultiple","Expandable","Nested","NestedComponentSingle","NestedComponentMultiple","ExpandableWithMoreInfo","SelectableSingleWithMoreInfo","SelectableSingleWithMoreInfoOpen","SelectableMultipleWithMoreInfo"];export{c as AllAvailableElements,p as Clickable,m as Editable,h as Expandable,b as ExpandableWithMoreInfo,g as Nested,S as NestedComponentMultiple,_ as NestedComponentSingle,v as SelectableMultiple,n as SelectableMultipleWithMoreInfo,u as SelectableSingle,a as SelectableSingleWithMoreInfo,f as SelectableSingleWithMoreInfoOpen,_e as __namedExportsOrder,ge as default};
