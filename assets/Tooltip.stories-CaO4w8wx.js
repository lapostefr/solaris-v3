import{a as s}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{T as p,S as c,C as m}from"./Tooltip-D1JQ9w2q.js";import"./v4-CQkTLCs1.js";import"./vue.esm-bundler-BQVOD3cV.js";import"./index-KgIASP7u.js";import"./generateId-CVaf2GGW.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const d=["top","top-start","top-end","bottom","bottom-start","bottom-end","left","left-start","left-end","right","right-start","right-end"],y=["hover","clickToOpen","clickToToggle","focusOnly"],u=["default","long","empty-border","empty-no-arrow","empty"],f={slotTrigger:{description:`Use the slot nammed *trigger* for the tooltip trigger element with the ARIA attributes exposed by the slot.*(cf. Show code)*. 
